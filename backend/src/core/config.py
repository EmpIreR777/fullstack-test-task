...
ENV_FILE_PATH = BASE_DIR.parent / '.env'  # <project>/backend/.env
...
class Settings(BaseSettings):
    ...
    API_TITLE: str = 'FileGuard API'
    API_DESCRIPTION: str = 'API для загрузки файлов, проверки на угрозы и управления алертами'
